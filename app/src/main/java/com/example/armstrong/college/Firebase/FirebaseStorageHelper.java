package com.example.armstrong.college.Firebase;
...
public class FirebaseStorageHelper {
    ...
    private void init(){
        ...
        rootRef = firebaseStorage.getReferenceFromUrl("add your com.example.armstrong.college.Firebase database path");
    }
