...
public class LoginActivityAdmin extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnSignUp).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivityAdmin.this, SignUpActivityAdmin.class);
        ...
        findViewById(R.id.btn_reset_password).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivityAdmin.this, ResetPasswordActivity.class);
                startActivity(intent);
            }
        });
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (null != user) {
                                        Intent intent = new Intent(LoginActivityAdmin.this, AdminDrawer.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                } else {
                                    hideProgress();
                                    Utility.alert(LoginActivityAdmin.this, null, task.getException().getMessage());
                                }
                            }
                        });
