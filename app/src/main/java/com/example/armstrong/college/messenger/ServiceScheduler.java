package com.example.armstrong.college.messenger;
...
public final class ServiceScheduler {
    ...
    private static final String MESSENGER_ENABLED = "com.example.armstrong.college.messenger.MESSENGER_ENABLED";
