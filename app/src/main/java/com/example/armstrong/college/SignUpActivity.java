...
public class SignUpActivity extends MainActivity {
    ...
    private EditText editFirstName, editLastName, editSignUpEmail,editAge,editSex,editCourse, editMobileNumber, editSignUpPassword, editSignUpConfirmPassword;
                                                    ...
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        database.addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                ...
                                                                if (null != user) {
                                                                    Intent intent = new Intent(SignUpActivity.this, AdminDrawer.class);
    ...
    private String firstName, lastName, email,age, sex, course, mobileNumber, password;
    ...
    private boolean isValidateSignUp() {
        ...
        if (email.length() == 0) {
            ...
            if (age.length() == 0) {
                editAge.setError("Required Field");
                isValidate = false;}
                ...
                if (sex.length() == 0) {
                    ...
                    if (course.length() == 0) {
                        editCourse.setError("Required Field");
                        isValidate = false;}
